...
class app(ShowBase):
    def __init__(self):
        ...
        def intro_level():
            def spawn_receiver_group(vertical_factor = 0, receiver_h = 0):
                # dropped cylinders test
                special_shape_x = 1
                special_shape_y = 10
                special_mass = 500
                d_coll_pos = Vec3(0,0,100)
                cylinder_choices = ['dropping_cylinder_2by10','dropping_cylinder_1by10','dropping_cylinder_05by10']  # ,'dropping_cylinder_025by10'
                
                for cylinder_choice in cylinder_choices:
                    if cylinder_choice == 'dropping_cylinder_2by10':
                        special_shape_x = 1
                        special_shape_y = 9  # 10
                        special_mass = 500
                        d_coll_pos = Vec3(0,0,d_coll_pos[2] + vertical_factor)
                    elif cylinder_choice == 'dropping_cylinder_1by10':
                        special_shape_x = 0.3  # 0.5
                        special_shape_y = 10
                        special_mass = 250
                        d_coll_pos = Vec3(10,0,d_coll_pos[2] + vertical_factor)
                    elif cylinder_choice == 'dropping_cylinder_05by10':
                        special_shape_x = 0.15  # 0.25
                        special_shape_y = 10
                        special_mass = 125
                        d_coll_pos = Vec3(10,8,d_coll_pos[2] + vertical_factor)
                    elif cylinder_choice == 'dropping_cylinder_025by10':
                        special_shape_x = 0.125
                        special_shape_y = 10
                        special_mass = 62.5
                        d_coll_pos = Vec3(-10,8,d_coll_pos[2])
                    ...
                    d_coll.set_pos(d_coll_pos)
                    box_model = self.loader.load_model('models/' + cylinder_choice + '.glb')
            ...
            test_receiver_1 = self.loader.load_model('models/test_receiver_1.glb')
            ...
            test_receiver_2 = self.loader.load_model('models/test_receiver_1.glb')
            ...
            test_receiver_3 = self.loader.load_model('models/test_receiver_1.glb')
            ...
            test_receiver_4 = self.loader.load_model('models/test_receiver_1.glb')
            ...
            test_receiver_5 = self.loader.load_model('models/test_receiver_1.glb')
            ...
            test_receiver_6 = self.loader.load_model('models/test_receiver_1.glb')
            ...
            def rotate_receiver(Task):
                ...
                if reference_z < -10 > -100:
                    ...
                    text_1.set_text('Receiver Rotation Value: ' + str(abs(round(test_receiver_2.get_h(), 1)))
                                                                      + '\n' + 'Target: 20')
                ...
                if reference_z < -110 > -310:
                    ...
                    text_1.set_text('Receiver Rotation Value: ' + str(abs(round(test_receiver_3.get_h(), 1)))
                                                                      + '\n' + 'Target: 25')
                ...
                if reference_z < -310 > -510:
                    ...
                    text_1.set_text('Receiver Rotation Value: ' + str(abs(round(test_receiver_4.get_h(), 1)))
                                                                      + '\n' + 'Target: 36')
                ...
                if reference_z < -510 > -660:
                    ...
                    text_1.set_text('Receiver Rotation Value: ' + str(abs(round(test_receiver_5.get_h(), 1)))
                                                                      + '\n' + 'Target: 27')
                ...
                if reference_z < -660 > -810:
                    ...
                    text_1.set_text('Receiver Rotation Value: ' + str(abs(round(test_receiver_6_coll.get_h(), 1)))
                                                                      + '\n' + 'Target: 17')
        ...
        def level_1():
            def spawn_receiver_group():
                ...
                for cyl_pos in large_cylinders:
                    ...
                    box_model = self.loader.load_model('models/' + 'dropping_cylinder_2by10' + '.glb')
                    # box_model.reparent_to(self.render)
                    box_model.copy_to(d_coll)
                    # box_model.set_pos(0,0,-1)
                ...
                for cyl_pos in medium_cylinders:
                    ...
                    d_coll.node().set_deactivation_enabled(False)  # prevents stopping the physics simulation
                    d_coll.set_pos(cyl_pos)
                    box_model = self.loader.load_model('models/' + 'dropping_cylinder_1by10' + '.glb')
                    # box_model.reparent_to(self.render)
                    box_model.copy_to(d_coll)
                    # box_model.set_pos(0,0,-1)
                ...
                for cyl_pos in small_cylinders:
                    ...
                    d_coll.node().set_deactivation_enabled(False)  # prevents stopping the physics simulation
                    d_coll.set_pos(cyl_pos)
                    box_model = self.loader.load_model('models/' + 'dropping_cylinder_05by10' + '.glb')
                    # box_model.reparent_to(self.render)
                    box_model.copy_to(d_coll)
                    # box_model.set_pos(0,0,-1)
            ...
            '''
            # receiver instantiation
            test_receiver_1 = self.loader.load_model('models/test_receiver_2.glb')
            test_receiver_1.reparent_to(self.render)
            test_receiver_1.set_pos(0, 0, 0)
            test_receiver_1.set_h(40)
            self.test_receiver_1 = test_receiver_1
            ...
            test_receiver_2 = self.loader.load_model('models/test_receiver_2.glb')
            test_receiver_2.reparent_to(self.render)
            test_receiver_2.set_pos(0, 0, -100)
            test_receiver_2.set_h(20)
            self.test_receiver_2 = test_receiver_2
            ...
            test_receiver_3 = self.loader.load_model('models/test_receiver_2.glb')
            test_receiver_3.reparent_to(self.render)
            test_receiver_3.set_pos(0, 0, -300)
            test_receiver_3.set_h(25)
            self.test_receiver_3 = test_receiver_3
            ...
            test_receiver_4 = self.loader.load_model('models/test_receiver_2.glb')
            test_receiver_4.reparent_to(self.render)
            test_receiver_4.set_pos(0, 0, -500)
            test_receiver_4.set_h(36)
            self.test_receiver_4 = test_receiver_4
            ...
            test_receiver_5 = self.loader.load_model('models/test_receiver_2.glb')
            test_receiver_5.reparent_to(self.render)
            test_receiver_5.set_pos(0, 0, -650)
            test_receiver_5.set_h(27)
            self.test_receiver_5 = test_receiver_5
            ...
            test_receiver_6 = self.loader.load_model('models/test_receiver_2.glb')
            test_receiver_6.reparent_to(self.render)
            test_receiver_6.set_pos(0, 0, -800)
            test_receiver_6.set_h(17)
            self.test_receiver_6 = test_receiver_6
            ...
            test_receiver_7 = self.loader.load_model('models/test_receiver_2.glb')
            ...
            def cleanup_level():
                ...
                test_receivers = self.render.find_all_matches('**/test_receiver_*')
                for tc in test_receivers:
                    tc.detach_node()

                self.cam.set_pos(0,0,200)
                spawn_receiver_group()
            ...
            def rotate_receiver(Task):
                ...
                if reference_z < -810 > -1010:
                    ...
                    text_1.set_text('Receiver Rotation Value: ' + str(abs(round(test_receiver_7_coll.get_h(), 1)))
                                                                      + '\n' + 'Target: 52')
                ...
                if reference_z < -1010 > -1310:
                    ...
                    text_1.set_text('Receiver Rotation Value: ' + str(abs(round(test_receiver_8_coll.get_h(), 1)))
                                                                      + '\n' + 'Target: 128???')
